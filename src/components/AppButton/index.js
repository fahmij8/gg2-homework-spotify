...
function AppButton({
    ...
    if (buttonTheme === "primary") {
        selectedTheme =
            "bg-green-500 text-zinc-50 hover:bg-green-400 focus:bg-green-400 active:bg-green-400 ";
    } else if (buttonTheme === "secondary") {
        selectedTheme =
            "bg-white text-zinc-500 hover:bg-slate-300 focus:bg-slate-300 active:bg-slate-300 ";
    } else if (buttonTheme === "danger") {
        selectedTheme =
            "bg-red-500 text-zinc-50 hover:bg-red-400 focus:bg-red-400 active:bg-red-400 ";
    }

    selectedTheme +=
        "inline-block leading-tight focus:outline-none focus:ring-0 transition ease-in-out duration-75 hover:scale-105 ";
